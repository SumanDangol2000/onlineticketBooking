        ...
        <div class="card col-lg-5 col-md-8 " style="border-radius: 1rem;">
              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <div class="form-outline mb-3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Re-enter the password." ControlToValidate="forgotLoginRepeatPassword" Display="Dynamic" ForeColor="Red" ValidationGroup="forgotPasswordGroup"></asp:RequiredFieldValidator>
                  ...
                  <div class="pt-1 mb-4">
                      <!-- Submit button -->
                    <asp:Button ID="btnChangePassword" runat="server" Text="save" CssClass="btn btn-primary btn-lg btn-block mb-3"  ValidationGroup="forgotPasswordGroup" />
