        ...
        <div class="row g-3 my-2">
                 <div class="row">
                    ...
                    <div class="form-outline mb-3 col-lg-4 col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter flight number." ControlToValidate="txtFlightNumber" ForeColor="Red" ValidationGroup="flightGroup"></asp:RequiredFieldValidator>
                    </div>
                    ...
                    <div class="form-outline mb-3 col-lg-4 col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Enter department airport." ControlToValidate="txtDepartureAirport" ForeColor="Red" ValidationGroup="flightGroup"></asp:RequiredFieldValidator>
                    </div>
                     ...
                     <div class="form-outline mb-3 col-lg-4 col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter arrival airport." ControlToValidate="txtArrivalAirport" ForeColor="Red" ValidationGroup="flightGroup"></asp:RequiredFieldValidator>
                    </div>
                    ...
                    <div class="form-outline mb-3 col-lg-4 col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter departure time." ControlToValidate="txtDepartureTime" ForeColor="Red" ValidationGroup="flightGroup"></asp:RequiredFieldValidator>
                    </div>
                     ...
                     <div class="form-outline mb-3 col-lg-4 col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter arrival time." ControlToValidate="txtArrivalTime" ForeColor="Red" ValidationGroup="flightGroup"></asp:RequiredFieldValidator>
                    </div>
                    ...
                    <div class="form-outline mb-3 col-lg-4 col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Enter duration time." ControlToValidate="txtDuration" ForeColor="Red" ValidationGroup="flightGroup"></asp:RequiredFieldValidator>
                    </div>
                     ...
                     <div class="form-outline mb-3 col-lg-4 col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Enter airline id." ControlToValidate="txtAirlineId" ForeColor="Red" ValidationGroup="flightGroup"></asp:RequiredFieldValidator>
                    </div>
                ...
                <div class="table-responsive">
                    <asp:GridView ID="GridViewFlight" runat="server" AutoGenerateColumns="False" DataKeyNames="flight_id" Width="100%" AllowPaging="True" PageSize="15" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="departure_airport" HeaderText="Departure airport" SortExpression="departure_airport"></asp:BoundField>
                            <asp:BoundField DataField="arrival_airport" HeaderText="Arrival airport" SortExpression="arrival_airport"></asp:BoundField>
