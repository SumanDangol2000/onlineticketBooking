        ...
        <div class="row g-3 my-2">
                 <div class="row">
                    ...
                    <div class="form-outline mb-3 col-lg-4 col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter your first name." ControlToValidate="txtairline" ForeColor="Red" ValidationGroup="airlineGroup"></asp:RequiredFieldValidator>
                    </div>
                    ...
                    <div class="form-outline mb-3 col-lg-4 col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Enter your last name." ControlToValidate="txtairlineAdd" ForeColor="Red" ValidationGroup="airlineGroup"></asp:RequiredFieldValidator>
                    </div>

                     <div class="pt-1 mb-4 ">
                        <!-- Submit button -->
                         <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-primary btn-lg btn-block mb-3" Width="250" ValidationGroup="airlineGroup" OnClick="btnSave_Click" />
                    </div>
            </div>
        ...
        <%--<div class="row my-5">
            <div class="form-group">
                <div class="table-responsive">
                    <asp:GridView ID="GridViewAirlines" runat="server" AutoGenerateColumns="False" Width="100%" DataKeyNames="review_id" OnPageIndexChanging="OnPageIndexChanging_Review"
                            OnRowCancelingEdit="GridViewAirline_RowCancelingEdit" OnRowEditing="GridViewAirline_RowEditing" OnRowUpdating="GridViewAirline_RowUpdating" PageSize="15" 
